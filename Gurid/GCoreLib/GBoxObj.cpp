...
HRESULT GBoxObj::LoadShaderFile(ID3D11Device* pDevice, const TCHAR* pShaderFile)
{
	HRESULT hr = S_OK;
	GShape::LoadShaderFile(pDevice, pShaderFile);
...
bool GBoxObj::SetSO(ID3D11Device* pd3dDevice, ID3D11DeviceContext*  pContext)
{
...
bool GBoxObj::RenderMesh(ID3D11DeviceContext*  pContext, bool bFirstRender)
{
	PreRender(pContext);
...
bool GBoxObj::Render(ID3D11DeviceContext*  pContext)
{
	PreRender(pContext);
