...
LRESULT GWindow::WindowMsgProc( HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam )
{
  ...
  //          {			
		...
		case WM_CLOSE:
        {
            ...
            DestroyWindow( hWnd );
            UnregisterClass( L"GBASIS3D11_Sample", NULL );            
            return 0;
        }
		case WM_DESTROY:
            PostQuitMessage( 0 );
...
bool GWindow::InitWindow(HINSTANCE hInstance, int nCmdShow, TCHAR* strWindowTitle,  int iWidth, int iHeight, BOOL IsFullScreen)
{
    ...
    wcex.lpszClassName = L"GBASIS3D11_Sample";
    ...
    m_hWnd = CreateWindow( L"GBASIS3D11_Sample",strWindowTitle, WS_OVERLAPPEDWINDOW,
