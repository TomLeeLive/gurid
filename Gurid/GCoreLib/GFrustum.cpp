...
bool GFrustum::PreRender(ID3D11DeviceContext*    pContext)
{
	...
	// 0    3  
	// 앞면
	m_VertexList[0] = PNCT_VERTEX(m_vFrustum[1], D3DXVECTOR3( 0.0f, 0.0f, -1.0f ),D3DXVECTOR4( 1.0f,0.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[1] = PNCT_VERTEX(m_vFrustum[2],  D3DXVECTOR3( 0.0f, 0.0f, -1.0f ),D3DXVECTOR4( 1.0f,0.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f)  );
	m_VertexList[2] = PNCT_VERTEX(m_vFrustum[3],  D3DXVECTOR3( 0.0f,0.0f, -1.0f ),D3DXVECTOR4( 1.0f,0.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f) );
	m_VertexList[3] = PNCT_VERTEX(m_vFrustum[0], D3DXVECTOR3( 0.0f,0.0f, -1.0f ),D3DXVECTOR4( 1.0f,0.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f) );
	// 뒷면
	m_VertexList[4] = PNCT_VERTEX(m_vFrustum[6], D3DXVECTOR3( 0.0f, 0.0f, 1.0f ),D3DXVECTOR4(0.0f,1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[5] = PNCT_VERTEX(m_vFrustum[5],  D3DXVECTOR3( 0.0f, 0.0f, 1.0f ),D3DXVECTOR4(0.0f,1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f) );
	m_VertexList[6] = PNCT_VERTEX(m_vFrustum[4],  D3DXVECTOR3( 0.0f, 0.0f, 1.0f ),D3DXVECTOR4(0.0f,1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f)  );
	m_VertexList[7] = PNCT_VERTEX(m_vFrustum[7], D3DXVECTOR3( 0.0f, 0.0f, 1.0f ), D3DXVECTOR4(0.0f,1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f) );

	// 왼쪽
	m_VertexList[8] = PNCT_VERTEX(m_vFrustum[5], D3DXVECTOR3( 1.0f, 0.0f, 0.0f ),D3DXVECTOR4(0.0f, 0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[9] = PNCT_VERTEX(m_vFrustum[1],  D3DXVECTOR3( 1.0f, 0.0f, 0.0f ),D3DXVECTOR4(0.0f, 0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f)  );
	m_VertexList[10] = PNCT_VERTEX(m_vFrustum[0],  D3DXVECTOR3( 1.0f, 0.0f, 0.0f ),D3DXVECTOR4(0.0f, 0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f)  );
	m_VertexList[11] = PNCT_VERTEX(m_vFrustum[4],  D3DXVECTOR3( 1.0f, 0.0f, 0.0f ),D3DXVECTOR4(0.0f, 0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f) );

	// 오늘쪽면
	m_VertexList[12] = PNCT_VERTEX(m_vFrustum[2],D3DXVECTOR3( -1.0f, 0.0f, 0.0f ), D3DXVECTOR4( 1.0f,0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[13] = PNCT_VERTEX(m_vFrustum[6],  D3DXVECTOR3( -1.0f, 0.0f, 0.0f ),D3DXVECTOR4( 1.0f,0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f)  );
	m_VertexList[14] = PNCT_VERTEX(m_vFrustum[7],  D3DXVECTOR3( -1.0f, 0.0f, 0.0f ),D3DXVECTOR4( 1.0f,0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f)  );
	m_VertexList[15] = PNCT_VERTEX(m_vFrustum[3],  D3DXVECTOR3( -1.0f, 0.0f, 0.0f ),D3DXVECTOR4( 1.0f,0.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f)  );

	// 윗면
	m_VertexList[16] = PNCT_VERTEX(m_vFrustum[5], D3DXVECTOR3( 0.0f, 1.0f, 0.0f ),D3DXVECTOR4( 1.0f, 1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[17] = PNCT_VERTEX(m_vFrustum[6],  D3DXVECTOR3( 0.0f, 1.0f, 0.0f ),D3DXVECTOR4( 1.0f, 1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f)  );
	m_VertexList[18] = PNCT_VERTEX(m_vFrustum[2],  D3DXVECTOR3( 0.0f, 1.0f, 0.0f ),D3DXVECTOR4( 1.0f, 1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f) );
	m_VertexList[19] = PNCT_VERTEX(m_vFrustum[1],  D3DXVECTOR3( 0.0f, 1.0f, 0.0f ),D3DXVECTOR4( 1.0f, 1.0f, 0.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f) );

	// 아랫면
	m_VertexList[20] = PNCT_VERTEX(m_vFrustum[0],D3DXVECTOR3( 0.0f, -1.0f, 0.0f ), D3DXVECTOR4(0.0f,1.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 0.0f)  );
	m_VertexList[21] = PNCT_VERTEX(m_vFrustum[3],  D3DXVECTOR3( 0.0f, -1.0f, 0.0f ),D3DXVECTOR4(0.0f,1.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 0.0f)  );
	m_VertexList[22] = PNCT_VERTEX(m_vFrustum[7],  D3DXVECTOR3( 0.0f, -1.0f, 0.0f ),D3DXVECTOR4(0.0f,1.0f, 1.0f, 1.0f ),D3DXVECTOR2( 1.0f, 1.0f)  );
	m_VertexList[23] = PNCT_VERTEX(m_vFrustum[4],  D3DXVECTOR3( 0.0f, -1.0f, 0.0f ),D3DXVECTOR4(0.0f,1.0f, 1.0f, 1.0f ),D3DXVECTOR2( 0.0f, 1.0f)  );

	pContext->UpdateSubresource( m_pBoxShape->m_Object.g_pVertexBuffer.Get(), 0, NULL, &m_VertexList.at(0), 0, 0);
	m_pBoxShape->SetMatrix( NULL, &m_mView, &m_mProj );
	m_pBoxShape->m_Object.PreRender(pContext);
	return true;
}
...
{
	pContext->UpdateSubresource(m_pBoxShape->m_Object.g_pConstantBuffer.Get(), 0, NULL, &m_pBoxShape->m_cbData, 0, 0);
	m_pBoxShape->m_Object.PostRender(pContext);
	return true;
}
