...
bool GAseParser::GetNormalListFromString(TCHAR* strFaceList, DWORD dwNumFace, GAseMesh*	pGeomObj, TCHAR* strToken)
{
...
void GAseParser::LoadTM(GAseMesh* pObject)
{
	// NodeTM	
...
void GAseParser::LoadVisAnimation(GAseMesh* pObject)
{
...
void GAseParser::LoadAnimation(GAseMesh* pObject)
{
...
void GAseParser::LoadMesh(GAseMesh* pObject)
{
...
{
	INT iObjectType = -1;
	auto pAseObject = make_shared<GAseMesh>();
	m_pAseMesh.push_back(pAseObject);

	GAseMesh*	pObject = pAseObject.get();
