...
bool GImeUI::ImeUi_Initialize(HWND hwnd, bool bDisable)
{
	if (m_bInitialized)
	{
		return true;
...
void GImeUI::ImeUi_Uninitialize()
{
	if (!m_bInitialized)
	{
		return;
...
void GImeUI::Initialize(HWND hWnd)
{
	ImeUi_Initialize(hWnd);
}
//--------------------------------------------------------------------------------------
void GImeUI::Uninitialize()
{
	ImeUi_Uninitialize();
}
BOOL GImeUI::OnImeComposition(WPARAM wParam, LPARAM lParam)
{
	HIMC	hIMC;
...
void GImeUI::ResetCompositionString()
{
	m_CompString.clear();
}
int GImeUI::WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
